...
test -s "$stage/calendar-user-reader.mjs"
test -s "$stage/calendar-auth-http.mjs"
test -s "$stage/frame-policy.mjs"
...
docker cp "$stage/calendar-user-reader.mjs" "$main_builder:/app/calendar-user-reader.mjs"
docker cp "$stage/calendar-auth-http.mjs" "$main_builder:/app/calendar-auth-http.mjs"
docker cp "$stage/frame-policy.mjs" "$main_builder:/app/frame-policy.mjs"
