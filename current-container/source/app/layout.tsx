        ...
        <body className={`${geistSans.variable} ${geistMono.variable} antialiased`}>
          <main style={{ minHeight: "100vh", display: "grid", placeItems: "center", background: "#f5f7f5", padding: 20 }}>
            <section style={{ width: "min(440px, 100%)", padding: 32, border: "1px solid #e1e8e4", borderRadius: 16, background: "#fff", boxShadow: "0 18px 60px rgba(26,69,49,.09)" }}>
              ...
              <a href="https://app.fandow.top/fd-026222/wis-marketing-hub/" target="_top" rel="noreferrer" style={{ display: "inline-block", marginTop: 12, padding: "10px 16px", borderRadius: 9, background: "#166b4b", color: "#fff", textDecoration: "none", fontWeight: 700 }}>返回中枢</a>
            </section>
          </main>
        </body>
      </html>
